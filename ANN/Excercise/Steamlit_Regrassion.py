...
##from ANN.app import EstimatedSalary

model = tf.keras.models.load_model('./ANN/Regrassion.h5')

# load encoder and scaler
path = './ANN/sl_label_enc_gender.pkl'
with open(path, 'rb') as f:
    label_encoder_gender = pickle.load(f)

with open('./ANN/sl_scaler.pkl', 'rb') as f:
    scaler = pickle.load(f)

with open('./ANN/sl_one_hot_encoder_geography.pkl', 'rb') as f:
